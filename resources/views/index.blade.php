					...
					<div id="main">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="singleJ.blade.php">Reconocer los conceptos de sistemas de infromación.</a></h2>
								...
								<a href="singleJ.blade.php" class="image featured"><img src="images/pc1.jpg" alt="" /></a>
								...
								<footer>
									<ul class="actions">
										<li><a href="singleJ.blade.php" class="button large">Continuar Leyendo</a></li>
									</ul>
									<ul class="stats">
						...
						<!-- Post -->
							<article class="post">
								<header>
									<div class="title">
										<h2><a href="singletwo.blade.php">Describir los sistemas con arquitectura Cliente / Servidor</a></h2>
										<p>Introducción a la arquitectura Cliente-Servidor</p>
									</div>
									<div class="meta">
								...
								<a href="singletwo.blade.php" class="image featured"><img src="images/p2.jpg" alt="" /></a>
								...
								<footer>
									<ul class="actions">
										<li><a href="singletwo.blade.php" class="button large">Continuar Leyendo</a></li>
									</ul>
									<ul class="stats">
										<li><a href="#">General</a></li>
										<li><a href="#" class="icon solid fa-heart">28</a></li>
							...
							<article class="post">
								...
								<a href="index6.blade.php" class="image featured"><img src="images/vista_control.png" alt="" /></a>
							...
							<article class="post">
								...
								<a href="index3.blade.php" class="image featured"><img src="images/servidor_clint.jfif" alt="" /></a>
							...
							<article class="post">
								...
								<a href="index4.blade.php" class="image featured"><img src="images/vista_control.png" alt="" /></a>
								...
								<div class="mini-posts">
									...
									<!-- Mini Post -->
										<article class="mini-post">
											<header>
												<h3><a href="singlethree.blade.php">Reconocer protocolos de comunicación de red</a></h3>
												<time class="published" datetime="2015-10-20">October 20, 2015</time>
												<a href="" class="author"><img src="images/avatar.jpg" alt="" /></a>
											</header>
											<a href="singlethree.blade.php" class="image"><img src="images/p3.jpg" alt="" /></a>
										</article>
